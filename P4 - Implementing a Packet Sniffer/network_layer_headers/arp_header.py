...
class ARPHeader(LayerHeader):
    def __init__(self, pkt):
        ...
        arp_header = unpack('!HHBBH6sI6sI', self.header_bytes)
        self.hardware_type = arp_header[0]
        self.protocol_type = arp_header[1]
        self.hardware_address_len = arp_header[2]
        self.protocol_address_len = arp_header[3]
        self.opcode = arp_header[4]
        self.sender_hardware_address = arp_header[5]
        self.sender_protocol_address = arp_header[6]
        self.target_hardware_address = arp_header[7]
        self.target_protocol_address = arp_header[8]
